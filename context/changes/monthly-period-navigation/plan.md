...
- [x] 3.1 Backend build/test oraz frontend typecheck/build przechodzą - b3ea61e
- [x] 3.2 Zakres nie duplikuje recurring ani goal-forecast - b3ea61e
- [x] 3.3 Manual smoke test jest gotowy do potwierdzenia - b3ea61e
